...
const styles = StyleSheet.create({
  ...
  calcValue: { flex: 1, fontFamily: 'JetBrainsMono', fontSize: 18, color: colors.textPrimary },
  calcSwap: { alignSelf: 'center' },
  rate: { marginTop: spacing.md },
  faqItem: {
    flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',
    paddingVertical: spacing.lg, borderBottomWidth: 1, borderBottomColor: colors.copperMuted,
